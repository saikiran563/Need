...
class UserBlock extends Component {
  ...
  render() {
    ...
    const { userInfo, showUserEdit, userEditMode } = this.props;
          ...
          <div className="col-xs-12 col-sm-8 description_box__large-container">
            <div className="row">
              <div className="col-xs-12 description_box__details">
                {
                  showUserEdit && <div className="description_box__read">
                    <p>{userInfo.read}</p>
                  </div>
                }
                {
                  !showUserEdit && userEditMode && <div className="description_box__form">
                    <div className="row">
              ...
              {
                showUserEdit && <div className="description_box__edit description_box__edit_section">
