    ...
    render() {
        ...
        return (
            ...
            <div className="modal_content">
                <p className="title title--lg">Get to know your role.</p>
            ...
            <br aria-hidden="true" />
                ...
                <div className="row rol-permissions">
                    <form action="#">
                        ...
                        {reactGlobals.deviceLandingUrl.indexOf("ao") > -1 ? <div className="rol-permissions__buttons">
                            <div className="col-xs-12 ">
                                <a href="#">Learn more</a>
...
export default connect(mapStateToProps, mapDispatchToProps)(AccessRoles)