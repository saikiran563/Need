...
class PrivacyPermissions extends Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (this.props.privacyDetails.privacySettings != prevProps.privacyDetails.privacySettings) {
      // console.log(this.props.privacyDetails.privacySettings)
      this.props.privacyDetails.privacySettings.privacySettingItems.map(item => {
        Object.keys(item.mtnSettingsMap).map(obj => {
          if(item.mtnSettingsMap[obj] === "Y"){
              count++
            }
          })
      })
