...
getinitialState(){
              ...
              return(
                <div>
                    <div className='row owner-info-second' key={eachManager.phoneNumber}>
                         ...
                         {
                           reactGlobals.role.toLocaleLowerCase()=='accountholder' &&
  ...
  getAccountManagerRequestsView(){
    if(reactGlobals.role.toLocaleLowerCase()=='mobilesecure') return <div /> // Account Members do not see pending requests
  ...
  handleSave = (e)=>{
    this.props.handleSave('accountmanagersBlock', this.state, e)
    this.setState(this.getinitialState())
  }

  getManagerAddView( managers, firstName, lastName, phoneNumber, emailId ){
    if(reactGlobals.role.toLocaleLowerCase()=='accountholder'){
    return(
            ...
            <div className='col-xs-12 col-sm-8 description_box__large-container'>
              ...
              }
              {
                  ...
                  <div className='description_box__edit description_box__edit_section'>
                    <a className='btn btn-anchor'  onClick={() => this.props.handleEditCancel('accountmanagersblock')} role='button'>Edit</a>
                  </div>
              }
            </div>
          </div>
