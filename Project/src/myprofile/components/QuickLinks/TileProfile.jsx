    ...
    return (
      ...
      <div className="row quicklinks-list">
        {reactGlobals.role.toLocaleLowerCase() == "ao" || reactGlobals.role.toLocaleLowerCase() == "am" ?
         ...
         {reactGlobals.role.toLocaleLowerCase() == "ao" ? <div className="col-sm-4" onClick={this.navigateToPage}>
        ...
        {reactGlobals.role.toLocaleLowerCase() == "ao" || reactGlobals.role.toLocaleLowerCase() == "am" ? <div className="col-sm-4" onClick={this.navigateToPage}>
