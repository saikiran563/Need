...
constructor(props, context){
    ...
    this.state = {
      ...
      billingAddress: this.props.contents
    };
    this.closepop=this.closepop.bind(this);

}
componentWillReceiveProps(nextProps){
    this.setState({billingAddress: nextProps.contents})
  }
closepop(){
 ...
 handleAddressChange(e){
  ...
  handleSave(){
    this.props.onSave(this.state.addressChecked);
    this.closepop();
  }
        ...
        return (
         ...
         <div id="overlayContainer" className={this.props.showPopup?'visible':'hidden'}>
            ...
            <div id="overlayFrame" className="animated fadeIn a-fast">
              <span className="close-wrapper"><a id="overlayClose" className="modal-close" onClick={this.closepop} role="button"><span className="a-sr a-sr-fix" aria-hidden="false">Close</span><span className="a-icon-overlay-close" aria-hidden="true"></span></a></span>
              <div>
                  ...
                  <div className="description_box__read">
                      <div className="row">
                          <div className="col-md-6 address-entered">
                                <p>{this.state.billingAddress.address} {this.state.billingAddress.apartment}</p>
                                <p>{`${this.state.billingAddress.city} ${this.state.billingAddress.state} ${this.state.billingAddress.zip}`}</p>
                          </div>
