	  ...
	  <div className="col-xs-12 col-sm-4 description_box__header">
		...
		showGreetingEdit &&
		 ...
		 !showGreetingEdit &&
            ...
            <InputField type="text" value={this.state.greetingMessage} handleOnChange={this.handleOnChange} placeholder="Name" name="greetingMessage" valid={requiredError} />
