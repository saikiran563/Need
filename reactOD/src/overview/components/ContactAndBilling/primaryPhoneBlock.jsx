     ...
     <div className="body">
                    ...
                    <div className="col-xs-12 col-sm-8 description_box__large-container">
                        <div className="row">
                                ...
                                {
                                    showPrimaryPhoneEdit &&  <div className="description_box__read">
                    ...
                    <div className="row">
                      <div className="col-xs-12 col-sm-5">
                        <div className="form-group phone-block-input">
                          ...
                          <InputField type="text" handleOnChange={this.handleOnChange} placeholder="555-555-5555" name="primaryphone" valid={isValidPrimary} pattern="^\d{3}.\d{3}.\d{4}$" touched={this.state.istouchedPrimary} value={userPrimaryPhone} />
                        </div>

                        <div className="form-group phone-block-input">
                          <label htmlFor="alternate phone number">Change Alternate Phone</label>
                          <InputField type="text" handleOnChange={this.handleOnAlternatePhoneChange} placeholder="555-555-5555" name="alternatephone" valid={isValidAlternate} pattern="^\d{3}.\d{3}.\d{4}$" touched={this.state.istouchedAlternate} value={userAlternatePhone} />
                        </div>
